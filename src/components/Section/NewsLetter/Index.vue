                ...
                <div class="col-lg-12">
                    <div class="news-letter-wraps">
                        ...
                        <form action="#">
                            ...
                            <button type="submit"><span class="gradienTxt">Submit</span></button>
                        </form>
                    </div>
                </div> 
            </div>
...
<style scoped> 
section.news-letter-section[data-v-20c6c8f9] {
    margin-top: 100px;
    margin-bottom: -90px;
}
.news-letter-wraps {
    ...
    box-shadow: 0px 4px 10px 0px rgba(12, 12, 12, 0.13);
    display: flex;
    align-items: center;
...
.news-letter-wraps form input {
    ...
    background: #FFF;
    height: 53px;
    padding: 17.41px 12px 17.59px 12px;
    outline: none;
    margin-right: 11px;
}
